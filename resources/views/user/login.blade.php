...
<li><a class="share-instagram" title="Instagram" href="https://www.instagram.com/livigro/" target="_blank" rel="nofollow noopener"><i class="fa fa-instagram" aria-hidden="true"></i><br />
	...
	<h1 class='sow-headline'><b>LIVIGRO</b> Login</h1>					<div class="decoration">
...
{!! Form::open(['action' => 'UserController@login','method' => 'POST','class' => 'wpcf7-form','id' => 'doctor','novalidate' => 'novalidate']) !!}
<div class="doctor">    
<div class="enqury_full">
<span class="wpcf7-form-control-wrap fname">
            {{Form::text('email', '',['class'=>'wpcf7-form-control wpcf7-text wpcf7-validates-as-required','placeholder'=>'Email ID','aria-required'=>'true','aria-invalid'=>'false'])}}
</span>
        </div>
    <div class="enqury_full">
    <span class="wpcf7-form-control-wrap fname">
            {{Form::password('password',['class'=>'wpcf7-form-control wpcf7-text wpcf7-validates-as-required','aria-required'=>'true','aria-invalid'=>'false','placeholder'=>'Password'])}}
</span>
        </div>
    <div class="enqury_btn">
    {{Form::submit('Login',['class'=>'wpcf7-form-control wpcf7-submit'])}}
</div>
